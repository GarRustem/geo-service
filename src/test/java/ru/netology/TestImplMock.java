...
public class TestImplMock {
    ...
    void beforeEach() {
        ...
        locService = Mockito.spy(LocalizationServiceImpl.class);
    ...
    public void testPositiveOneRU() {
        ...
        Location locationRU = geoService.byIp(ip);
        //Condition
    ...
    public void testPositiveTwoEN() {
        ...
        Location locationEN = geoService.byIp(ip);
        //Condition
    ...
    // Варианты для использования .mock() вместо .spy()
